    ...
    <div className="flex h-screen  min-w-[250px]  max-w-[250px] flex-col border-r bg-gray-100 p-4">
      ...
      <div className="grow space-y-1">
        ...
        <button
          ...
          className="mt-8 flex items-center justify-center space-x-2 rounded-md bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
          <PlusIcon />
          <span>ボードを追加</span>
        </button>
